    ...
    <div class="modal-dialog modal-dialog-centered modal-xxl">
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                <form class="form w-lg-1000px mx-auto" wire:submit.prevent="submit">
                    ...
                    @for ($i = 1; $i <= $totalSteps; $i++)
                        <div class="step-content @if ($currentStep == $i) d-block @else d-none @endif" data-step="{{ $i }}">
                            @include('livewire.audit.steps.step' . $i)
                        </div>
                    @endfor
...
<script>
    document.addEventListener('livewire:load', function () {
        let aDateRangePicker;

        function initializeADateRangePicker() {
            const dateInput = document.getElementById('a_date_range');

            if (dateInput && !aDateRangePicker) {
                aDateRangePicker = flatpickr(dateInput, {
                    mode: "range",
                    dateFormat: "Y-m-d",
                    altInput: true,
                    altFormat: "F j, Y",
        ...
        // Universal Flatpicker
        function initializeFlatpickrz() {
        const dateRangeInputs = document.querySelectorAll('.dateflatpickzz'); 
    ...
    Swal.fire({
            ...
            if (event.detail.icon === 'success') {
                ...
                // Reset Livewire state if necessary
